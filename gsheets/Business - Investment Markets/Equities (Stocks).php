...
$inputs = [
    ...
    "spreadsheetLocal"=>"equities-stocks.csv",

    /* Display */
    "pageTitle"=>"Quiz: Equities (Stocks)",
    "pageDescription"=>"Equities fundamentals — ownership, markets, orders/liquidity, corporate actions, indices/ETFs, regimes, and analysis styles (SAMPLE educational).",
