...
$inputs = [
    ...
    "spreadsheetLocal"=>"forex.csv",

    /* Display */
    "pageTitle"=>"Quiz: Forex (FX)",
    "pageDescription"=>"Forex fundamentals — pairs, pips, spreads, leverage risk, sessions, macro drivers (SAMPLE educational).",
