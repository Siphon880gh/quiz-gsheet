...
$inputs = [
    ...
    "spreadsheetLocal"=>"candlestick-patterns.csv",

    /* Display */
    "pageTitle"=>"Quiz: Candlestick Patterns",
    "pageDescription"=>"Candlestick fundamentals — anatomy, single/multi-candle patterns, context, confirmation, and recognition graphics.",
