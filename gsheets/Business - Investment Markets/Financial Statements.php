...
$inputs = [
    ...
    "spreadsheetLocal"=>"financial-statements.csv",

    /* Display */
    "pageTitle"=>"Quiz: Financial Statements",
    "pageDescription"=>"Financial statement fundamentals — income statement, balance sheet, cash flow, ratios, and earnings quality cues.",
