...
$inputs = [
    /* Connections — replace YOUR_* placeholders with your Google Sheet and service account key */
    "spreadsheetUrl"=>"https://docs.google.com/spreadsheets/d/YOUR_GOOGLE_SHEET_ID/",
    "tabName"=>"Distribution Points, Manufacturers, Suppliers",
    "creds"=>dirname(__FILE__) . "/../../keys/YOUR-SERVICE-ACCOUNT-KEY.json",

    /* Display */
    "pageTitle"=>"Quiz: Distribution Points, Manufacturers, Suppliers",
    "pageDescription"=>"Learn the concepts of Distribution Points, Manufacturers, Suppliers.",
